...
def number_guessing_game():
    ...
    print(f"""I'm thinking of a number between 1 and 20. You have {max_guesses} 
    ...
    while guesses_taken < max_guesses:
        ...
        try:
            guess = input(f"Attempt {guesses_taken + 1}/{max_guesses}. Enter your guess: ")
            guess = int(guess)
        ...
        if guess < secret_number:
            ...
            print(f"It took you {guesses_taken} {'guess' if guesses_taken == 1 else 'guesses'}.")
            return  # End the game when correct
        
        # Let the user know how many guesses they have left
        if guesses_taken < max_guesses:
            print(f"""You have {max_guesses - guesses_taken} 
                {'guess' if max_guesses - guesses_taken == 1 else 'guesses'} left.""")
